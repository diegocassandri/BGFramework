...
app.directive("uiInputDate", [function(){
	return {
		restrict: "E",
		...
		link: function($scope, element, attrs){			
			...
			$scope.dataMask = app.lang.l["masks"]["date"];
			...
			if (!!$scope.value){				
				var value = new Date(getDateFromFormat($scope.value, app.lang.l["formats"][f.fieldType.toLowerCase()]));
